...
class TestPrintPrinter(PrinterCase):
    ...
    def test_user_default(self):
        ...
        self.assertTrue(
            self.printer_dotmatrix.with_user(self.user_alice).is_user_default
        )
        ...
        self.assertEqual(self.Printer.with_user(self.user_alice).printers(),
                         self.printer_dotmatrix)

        self.printer_plotter.with_user(self.user_bob).set_user_default()
        self.assertTrue(
            self.printer_plotter.with_user(self.user_bob).is_user_default
        )
        ...
        self.assertEqual(self.Printer.with_user(self.user_bob).printers(),
    ...
    def test_user_groups(self):
        ...
        self.assertEqual(self.Printer.with_user(self.user_bob).printers(),
                         self.printer_inkjet)
        self.assertEqual(self.group_upstairs.with_user(self.user_alice).printers(),
                         self.printer_plotter)
        self.assertEqual(self.group_downstairs.with_user(self.user_alice).printers(),
                         self.printer_inkjet)
        self.assertEqual(self.group_upstairs.with_user(self.user_bob).printers(),
                         self.printer_dotmatrix)
        self.assertEqual(self.group_downstairs.with_user(self.user_bob).printers(),
                         self.printer_inkjet)
